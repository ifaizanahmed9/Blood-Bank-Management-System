...
<section class="my-5" id="contact">
  ...
  <div>
  <p class="text-center bg-dark text-white">Faizan Ahmed : +91 8210284061 <br> Mail : <a style="text-decoration:none;color:white;" href="mailto:ifaizanahmed9@gmail.com" > ifaizanahmed9@gmail.com </a><br> GitHub : <a style="text-decoration:none;color:white;" href="https://github.com/ifaizanahmed9"> ifaizanahmed9</a></p>
