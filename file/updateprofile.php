...
if(isset($_POST['update'])){
    ...
    if ($conn->query($update) === TRUE) {
        ...
        header( "C:/xampp/htdocs/first/rprofile.php?msg=".$msg);
    } else {
        $error = "Error: " . $sql . "<br>" . $conn->error;
        header( "C:/xampp/htdocs/first/rprofile.php?error=".$error );
    }
    $conn->close();
}
    ...
    if ($conn->query($update) === TRUE) {
        $msg= "Your profile is updated successfully.";
        header( "C:/xampp/htdocs/first/hprofile.php?msg=".$msg);
    } else {
        $error= "Error: " . $sql . "<br>" . $conn->error;
        header( "C:/xampp/htdocs/first/hprofile.php?error=".$error);
    }
    $conn->close();
}
}else{
    header("C:/xampp/htdocs/first/login.php.php");
}
?>